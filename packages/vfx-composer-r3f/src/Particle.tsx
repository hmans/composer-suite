...
export type ParticleProps = Object3DProps & {
 ...
 */
export const Particle = forwardRef<Object3D, ParticleProps>(
  ({ context = DefaultContext, ...props }, ref) => {
    const sceneObject = useRef<Object3D>(null!)
    const { particles, ecs } = useContext(context)
